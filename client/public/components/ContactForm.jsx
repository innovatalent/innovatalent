        ...
        <div className="modal-panel flex items-center justify-center" onClick={e => e.stopPropagation()} style={{height:'auto',minHeight:'300px',padding:'48px'}}>
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a href="https://wa.me/5492617172768?text=Hola%2C%20acabo%20de%20enviar%20una%20solicitud%20en%20la%20web" target="_blank" rel="noopener" className="btn-primary" style={{borderColor: 'oklch(0.65 0.16 150 / 0.4)', color: 'oklch(0.85 0.13 150)'}}>
