        ...
        <div>
          ...
          <div className="reveal mt-8 card p-7 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex flex-col-reverse sm:flex-row gap-3 w-full md:w-auto">
              <a href="https://wa.me/5492617172768?text=Hola%2C%20quiero%20consultar%20por%20automatizaci%C3%B3n%20%2F%20web%20%2F%20data" target="_blank" rel="noopener" className="btn-ghost !text-[14px] !px-5 !py-3 justify-center whitespace-nowrap cursor-pointer" style={{borderColor: 'oklch(0.65 0.16 150 / 0.45)', color: 'oklch(0.85 0.13 150)'}}>
