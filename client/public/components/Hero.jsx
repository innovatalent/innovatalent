      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 w-full">
        <div className="max-w-4xl">
          ...
          <div className="reveal reveal-delay-3 flex flex-col-reverse sm:flex-row flex-wrap items-stretch sm:items-center gap-3 mb-16">
            <a href="https://wa.me/5492617172768?text=Hola%2C%20quiero%20info%20sobre%20Innova%20Talent%20Labs" target="_blank" rel="noopener" className="btn-ghost justify-center" style={{borderColor: 'oklch(0.65 0.16 150 / 0.45)', color: 'oklch(0.85 0.13 150)'}}>
