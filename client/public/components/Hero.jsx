        ...
        <div className="max-w-4xl">
          <div className="reveal flex items-center gap-2 mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-surface border border-line">
              ...
              <span className="font-mono text-[11px] uppercase tracking-wider text-dim">Cupos limitados esta semana</span>
            </div>
          </div>
          ...
          <div className="reveal reveal-delay-3 flex flex-col-reverse sm:flex-row flex-wrap items-stretch sm:items-center gap-3 mb-16">
            <a href="https://wa.me/5492617172768?text=Hola%2C%20quiero%20info%20sobre%20Innova%20Talent%20Labs" target="_blank" rel="noopener" className="btn-primary justify-center" style={{borderColor: 'oklch(0.65 0.16 150 / 0.4)', color: 'oklch(0.85 0.13 150)'}}>
