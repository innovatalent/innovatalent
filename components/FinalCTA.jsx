    ...
    <section className="relative py-32 overflow-hidden border-t border-line">
      ...
      <div className="relative max-w-5xl mx-auto px-6 lg:px-10 text-center">
        <div className="reveal inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-surface border border-line mb-8">
          ...
          <span className="font-mono text-[11px] uppercase tracking-wider text-dim">3 kickoffs abiertos este mes</span>
        </div>

        <h2 className="reveal reveal-delay-1 text-[clamp(44px,8vw,108px)] leading-[0.98] font-semibold tracking-[-0.04em] mb-8">
          Armá tu equipo<br/>
          <span className="italic font-light stroke-gradient">hoy.</span>
        </h2>

        <p className="reveal reveal-delay-2 text-dim text-[18px] md:text-[20px] leading-[1.55] max-w-2xl mx-auto mb-12">
          Primera reunión de 30 minutos. Vamos directo al punto: qué querés construir y qué tipo de talento necesitás para lograrlo.
        </p>

        <div className="reveal reveal-delay-3 flex flex-col sm:flex-row items-center justify-center gap-3 mb-16">
          <button onClick={onCTA} className="btn-primary !text-[16px] !px-7 !py-4">
            Agendá una llamada
          ...
          <a href="https://w.app/innovatalentlabs" target="_blank" rel="noopener" className="btn-ghost !text-[16px] !px-7 !py-4">
          ...
          <a href="mailto:consulting@innovatalentlabs.com" className="btn-ghost !text-[16px] !px-7 !py-4">consulting@innovatalentlabs.com</a>
        </div>
        ...
        <div className="reveal reveal-delay-4 grid grid-cols-2 md:grid-cols-4 gap-4 pt-12 border-t border-line max-w-3xl mx-auto">
          {[
            ...
            ['21 días promedio', 'Al primer hire'],
            ['Screen por ingenieros', 'Hecho por seniors'],
          ].map(([a, b]) => (
